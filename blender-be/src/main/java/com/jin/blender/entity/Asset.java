...
public class Asset {
    ...
    public String getQuarkUrl() { return quarkUrl; }
    public void setQuarkUrl(String quarkUrl) { this.quarkUrl = quarkUrl; }

    public String getExtractionCode() { return extractionCode; }
    public void setExtractionCode(String extractionCode) { this.extractionCode = extractionCode; }

    public String getSyncStatus() { return ReviewStatus.normalize(syncStatus); }
